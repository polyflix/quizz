...
export class AddUserTable1654262336281 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "quizz" ADD "visibility" "public"."quizz_visibility_enum" NOT NULL DEFAULT 'public'`
    );
    await queryRunner.query(
      `ALTER TABLE "quizz" ADD CONSTRAINT "FK_adb0b668e6f76ff4d94885483d5" FOREIGN KEY ("user_id") REFERENCES "user"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "quizz" DROP CONSTRAINT "FK_adb0b668e6f76ff4d94885483d5"`
    );
